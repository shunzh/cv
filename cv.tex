...
\rhead{Shun Zhang, Computer Science}
...
\newcommand\extwebpage[1]{\href{#1}{[link]}}
...
1 University Station A8000   & \includegraphics[width=110px]{phone.png}\\
Austin, TX  78712     & \email{jensen.zhang@utexas.edu}\\
\url{http://cs.utexas.edu/~menie482/} & \\
\end{tabular}


\section{Research Interests}

Reinforcement learning, robotics, multiagent systems, convex optimization, human
cognition.
...
\item[] Integrated B.S./M.S. Program,
        ...
        \item \hyperref[sec:masterThesis]{Master Thesis}.
        \end{innerlist}
\end{outerlist}
\vspace{.1in}
...
\textbf{Modular Reinforcement Learning} \hfill {Fall 2014 --- Spring 2015}
\label{sec:masterThesis}
\begin{innerlist}
...
(MDP) trained for preliminary tasks, how would these MDPs contribute to complicated
behaviors?}
...
\extwebpage{http://texasurj.com/archives/2014.pdf}, page 77.
\end{innerlist}
\vspace{.1in}
...
Systems (AAMAS), 2014. \webpage{papers/Au14SemiAIM.pdf}
\item Tsz-Chiu Au, {\bf Shun Zhang}, and Peter Stone. Autonomous Intersection
Management for Semi-Autonomous Vehicles. In Handbook of Transportation, 2015.
\webpage{papers/Routledge15-Au.pdf}
\footnote{This is the extended version of the Semi-Autonomous Intersection
Management paper.}
\item Katie Genter, {\bf Shun Zhang}, and Peter Stone. Determining Placements of
Influencing Agents in a Flock.  Autonomous Agents and Multiagent Systems
(AAMAS), 2015.
\item {\bf Shun Zhang}, Matthew Tong, Mary Hayhoe, Dana Ballard. Modular Inverse
Reinforcement Learning on Human Motion. Reinforcement Learning and Decision
Making (RLDM), 2015.
\end{innerlist}
...
\item AAAI Conference, Austin, TX, 2015.
\end{innerlist}
...
Final Project: \textit{Mixing Time in Reinforcement Learning Convergence
Analysis .  \webpage{papers/mix.pdf}}
\item Machine Learning (CS 391L)\\
Project reports:
\begin{innerlist}[before=\itshape,font=\normalfont]
\item Principal Component Analysis. \webpage{391L/project1.pdf}
\item Independent Component Analysis. \webpage{391L/project2.pdf}
\item Approximate Inference in Bayesian Networks. \webpage{391L/project4.pdf}
\item Reinforcement Learning. \webpage{391L/project5.pdf}
\item Genetic Algorithm. \webpage{391L/project6.pdf}
\end{innerlist}
...
Project reports:
\begin{innerlist}[before=\itshape,font=\normalfont]
\item N-armed bandit Problem. \webpage{394proj1/report.html}
\item Eligibility Traces. \webpage{394proj2/report.html}
\item Bootstrapping with Function Approximation. \webpage{394proj3/report.html}
\item Transfer Learning in Gridworld. \webpage{394proj4/report.pdf}
\end{innerlist}
\item Introduction to Mathematical Logic (CS 388L)
\item Automated Logical Reasoning (CS 395T)
\end{innerlist}
\vspace{.1in}
...
Final Project: \textit{List Interpreter. \webpage{345final/Lisp.pdf}}
\item etc.
\end{innerlist}
...
\item[] Seattle, WA
\vspace{.05in}
\item Created an internal tool that supports WebRTC in Firefox.
\item Modifying an internal tool for visualizing customer data, using Scala on
Spark.
\end{innerlist}
\vspace{.1in}
...
\item[] Austin, TX
\vspace{.05in}
\item Integrating a GUI viewer to Smart Differencer (TM) tools. Using JavaCC for
parsing and Swing for GUI.
\end{innerlist}
