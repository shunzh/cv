...
Reinforcement learning, robotics, multiagent systems, theoretical machine
...
\item[] Integrated B.S./M.S. Program,
        ...
        \item \hyperref[sec:masterThesis]{Master Thesis} with Prof. Peter Stone.
        \end{innerlist}
\end{outerlist}
\vspace{.1in}
...
\textbf{Reinforcement Learning on Atari Games} \hfill {Fall 2013, Winter 2014 ---
Spring 2015}
...
\item Preliminary results in Undergraduate research course
\webpage{papers/texplore.pdf}, continued for the master thesis.
\end{innerlist}
\vspace{.1in}
